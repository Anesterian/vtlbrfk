...
if ( ! function_exists( 'medic_setup' ) ) :
	...
	function medic_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'medic' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'medic_custom_background_args', array(
...
function medic_scripts() {
	wp_enqueue_style( 'medic-style', get_stylesheet_uri() );

	wp_enqueue_script( 'medic-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'medic-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
